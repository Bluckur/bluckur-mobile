		...
		private void loadNextItems()
		{
			...
			for (int i = tempCounter; i < tempCounter + 5; i++)
			{
				...
				for (int j = 0; j < 2; j++)
				{
					...
					stackLayout.HorizontalOptions = new LayoutOptions(LayoutAlignment.Center, false);
					...
					productPriceStackLayout.HorizontalOptions = new LayoutOptions(LayoutAlignment.End, true);
